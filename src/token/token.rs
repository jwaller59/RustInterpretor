...
impl TokenType {
    pub fn retrieve_string(&self) -> &str {
        match self {
            ...
            Self::Operator(Operator::PLUS(s)) => s,
            Self::Operator(Operator::EQ(s)) => s,
            Self::Operator(Operator::NOEQUAL(s)) => s,
            Self::Operator(Operator::SLASH(s)) => s,
            Self::Operator(Operator::ASSIGN(s)) => s,
            Self::Operator(Operator::ASTER(s)) => s,
            Self::Operator(Operator::LTHAN(s)) => s,
            Self::Operator(Operator::GTHAN(s)) => s,
